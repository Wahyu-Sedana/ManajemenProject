            ...
            <x-filament::section>
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-medium text-gray-900 dark:text-white">
                        {{ $selectedProject ? $selectedProject->name : __('project.select_project') }}
                    </h2>

                    <div>
                        <x-filament::input.wrapper>
                            <x-filament::input.select wire:model.live="projectId">
                                <option value="">{{ __('project.select_project') }}</option>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow">
                <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white">
                            {{ __('project.title.ticket_timeline') }}</h2>
                    </div>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('project.timeline_description') }}
                    </p>
                </div>
                                    ...
                                    <td class="px-4 py-4 border-r border-gray-200 dark:border-gray-600">
                                        <div class="flex flex-col">
                                            ...
                                            <div
                                                ...
                                                <span>{{ __('project.due') }}: {{ $task['end_date'] }}</span>
                                            </div>
                                        </div>
                                    </td>
                                                ...
                                                <div class="absolute top-0 h-full flex items-center justify-center text-xs font-medium text-white rounded-sm overflow-hidden whitespace-nowrap group cursor-default"
                                                    ...
                                                    <div class="absolute top-0 h-full flex items-center justify-center text-xs font-medium text-white rounded-sm overflow-visible whitespace-nowrap group cursor-pointer"
                                                        ...
                                                        style="
                                                            ...
                                                            opacity: {{ $opacity }};">
                                                        <div
                                                            class="fixed hidden group-hover:flex flex-col bottom-auto left-auto transform translate-y-[-100%] mt-[-10px] px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-md whitespace-nowrap z-50 shadow-lg">
                                ...
                                <tr>
                                    <td colspan="{{ count($this->getMonthHeaders()) + 1 }}"
                                        ...
                                        <div class="flex flex-col items-center justify-center mb-3">
                                            ...
                                            <span>{{ __('project.no_tickets_found') }}</span>
                                            <span class="text-xs mt-1">
                                                {{ __('project.no_tickets_hint') }}
                                            </span>
                                        </div>
                                    </td>
                                </tr>
        ...
        @else
            <div class="flex flex-col items-center justify-center h-64 text-gray-500 dark:text-gray-400 gap-4">
                ...
                <h2 class="text-xl font-medium text-gray-600 dark:text-gray-300">
                    {{ __('project.select_project_first') }}</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ __('project.select_project_description') }}
                </p>
            </div>
        @endif
    </div>
